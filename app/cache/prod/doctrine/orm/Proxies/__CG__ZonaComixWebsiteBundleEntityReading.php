 ...
 */
class Reading extends \ZonaComix\WebsiteBundle\Entity\Reading implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'user', 'comic', 'id', 'chapter', 'page', 'panel');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Reading $proxy) {
    ...
    public function setPanel($panel)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPanel', array($panel));

        return parent::setPanel($panel);
    }
    ...
    public function getPanel()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPanel', array());
