...
class __TwigTemplate_a49a6eb3849e916f7bbc64c6895ca331eaed18ee60c1873bb7ee90567b7e94eb extends Twig_Template
{
...
\t\t\t\t\t\t";
            // line 11
            if (($this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "displayName", array()) == "")) {
                // line 12
                echo "\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t";
            // line 17
            if (file_exists((("avatars/" . $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "id", array())) . ".jpg"))) {
                // line 18
                echo "\t\t\t\t\t\t\t<img src=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl((("avatars/" . $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "id", array())) . ".jpg")), "html", null, true);
...
\t\t\t\t\t\t\t<div class=\"col-xs-6 text-left\">";
            // line 24
            echo twig_escape_filter($this->env, (isset($context["published"]) ? $context["published"] : $this->getContext($context, "published")), "html", null, true);
            echo "</div>
...
\t\t\t\t\t\t\t";
        ...
        if (((isset($context["page"]) ? $context["page"] : $this->getContext($context, "page")) > 1)) {
            // line 79
            echo "\t\t\t\t\t\t\t\t<li><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("zona_comix_website_home", array("page" => ((isset($context["page"]) ? $context["page"] : $this->getContext($context, "page")) - 1))), "html", null, true);
            echo "\">Anterior</a></li>
\t\t\t\t\t\t\t";
        }
        // line 81
        echo "\t\t\t\t\t\t\t";
        if (((isset($context["entries"]) ? $context["entries"] : $this->getContext($context, "entries")) == 11)) {
            // line 82
            echo "\t\t\t\t\t\t\t\t<li><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("zona_comix_website_home", array("page" => ((isset($context["page"]) ? $context["page"] : $this->getContext($context, "page")) + 1))), "html", null, true);
            echo "\">Siguiente</a></li>
